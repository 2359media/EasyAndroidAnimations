 ...
 * 
 */
public class FoldInAnimation extends Animation {
	 ...
	 */
	public FoldInAnimation(View view) {
		this.view = view;
		numOfFolds = 1;
	...
	public void animate() {
		...
		foldInAnim.addListener(new AnimatorListenerAdapter() {
			...
			public void onAnimationEnd(Animator animation) {
				if (getListener() != null) {
					getListener().onAnimationEnd(FoldInAnimation.this);
				}
			}
		});
		foldInAnim.start();
	 ...
	 *         chained.
	 */
	public FoldInAnimation setNumOfFolds(int numOfFolds) {
	 ...
	 *         chained.
	 */
	public FoldInAnimation setOrientation(Orientation orientation) {
	 ...
	 *         chained.
	 */
	public FoldInAnimation setAnchorFactor(float anchorFactor) {
	 ...
	 *         chained.
	 */
	public FoldInAnimation setInterpolator(TimeInterpolator interpolator) {
	 ...
	 *         chained.
	 */
	public FoldInAnimation setDuration(long duration) {
	 ...
	 *         chained.
	 */
	public FoldInAnimation setListener(AnimationListener listener) {
