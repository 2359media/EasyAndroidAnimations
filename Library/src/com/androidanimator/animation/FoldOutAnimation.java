...
import com.androidanimator.animation.FoldLayout.Orientation;
 ...
 * 
 */
public class FoldOutAnimation extends Animation {
	 ...
	 */
	public FoldOutAnimation(View view) {
		this.view = view;
		numOfFolds = 1;
	...
	public void animate() {
		...
		foldAnim.addListener(new AnimatorListenerAdapter() {
			...
			public void onAnimationEnd(Animator animation) {
				...
				if (getListener() != null) {
					getListener().onAnimationEnd(FoldOutAnimation.this);
				}
			}
		});
		foldAnim.start();
	 ...
	 *         chained.
	 */
	public FoldOutAnimation setNumOfFolds(int numOfFolds) {
	 ...
	 *         chained.
	 */
	public FoldOutAnimation setOrientation(Orientation orientation) {
	 ...
	 *         chained.
	 */
	public FoldOutAnimation setAnchorFactor(float anchorFactor) {
	 ...
	 *         chained.
	 */
	public FoldOutAnimation setInterpolator(TimeInterpolator interpolator) {
	 ...
	 *         chained.
	 */
	public FoldOutAnimation setDuration(long duration) {
	 ...
	 *         chained.
	 */
	public FoldOutAnimation setListener(AnimationListener listener) {
