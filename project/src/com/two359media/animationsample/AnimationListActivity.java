 ...
 * {@link AnimationDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link AnimationListFragment} and the item details (if present) is a
...
public class AnimationListActivity extends Activity implements
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			arguments.putString(AnimationDetailFragment.ARG_ITEM_ID, id);
