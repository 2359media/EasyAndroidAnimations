...
import com.androidanimator.animation.FoldInAnimation;
import com.androidanimator.animation.FoldLayout.Orientation;
import com.androidanimator.animation.FoldOutAnimation;
...
public class AnimationDetailFragment extends Fragment implements
	...
	private void doAnimation() {
		...
		case 11:
			...
			new FoldInAnimation(card).setNumOfFolds(10)
					.setOrientation(Orientation.HORIZONTAL).animate();
			break;
		case 12:
			new FoldOutAnimation(card).setNumOfFolds(10)
